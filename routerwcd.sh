				...
				do
					...
					then
						...
						then
							...
							then
								echo -e "[$z$path_original] \033[32m[DISCREPANCY DETECTED] [+45% PROBABILITY]\033[0m"
								probability="45"
								...
								then
									echo -e "[$z$path_original] \033[32m[YOUR MATCH DETECTED: $setmatch] [+50% PROBABILITY]\033[0m"
									probability=$(expr $probability + 50)
								fi
